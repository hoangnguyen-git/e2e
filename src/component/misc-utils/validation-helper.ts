export class ValidationsHelper {
  static get types() {
    ...
    static getFieldNotDisplayedValidation(name: string) {
        return `${this.types.field} ${this.getNotDisplayedValidation(name)}`;
    }

    static getFieldNotEmpty(name: string) {
        return `Element ${name} is empty`;
    }

    static getFieldEmpty(name: string) {
        return `Element ${name} is not empty`;
    }

    static getMessageNotDisplayedValidation(msg: string) {
        return `Message ${this.getNotDisplayedValidation(msg)}`;
    }
